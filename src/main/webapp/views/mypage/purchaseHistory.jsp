...
<div class="page-container">
    ...
    <div class="tabs-container">
        <!-- 탭 -->
        <div class="tabs">
            <div class="tab active" id="tab-bid">구매 입찰</div>
            <div class="tab" id="tab-in-progress">진행 중</div>
            <div class="tab" id="tab-completed">종료</div>
        </div>
                    ...
                    <div class="pagination">
                        <c:choose>
                            <c:when test="${currentPage > 1}">
                                <a href="/haribo/jelly?page=purchaseHistory&currentPage=${currentPage - 1}">이전</a>
                            </c:when>
                            <c:otherwise>
                        ...
                        <c:forEach var="i" begin="1" end="${totalPages}">
                            <a href="/haribo/jelly?page=purchaseHistory&currentPage=${i}" class="${currentPage == i ? 'active' : ''}">
                                ${i}
                            </a>
                        </c:forEach>
                        ...
                        <c:choose>
                            <c:when test="${currentPage < totalPages}">
                                <a href="/haribo/jelly?page=purchaseHistory&currentPage=${currentPage + 1}">다음</a>
                            </c:when>
                            <c:otherwise>
